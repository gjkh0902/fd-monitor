      ...
      value: function handleError() {
        ...
        window.addEventListener('unhandledrejection', function (event) {
          try {
            ...
            _this.msg = event.reason.message || '';
  ...
  var BaseMonitor = /*#__PURE__*/function () {
    ...
    (0, _createClass2.default)(BaseMonitor, [{
      ...
      value: function handleErrorInfo() {
        ...
        if (txt.url && txt.url.length >= 100) txt.url = txt.url.substr(0, 200); //清除stack

        if (this.errorObj && this.errorObj.stack) delete this.errorObj.stack; //errorObj

        if (this.errorObj && !_utils.default.objectIsNull(this.errorObj)) {
  ...
  var MonitorJS = /*#__PURE__*/function () {
    ...
    (0, _createClass2.default)(MonitorJS, [{
      ...
      value: function init(options) {
        ...
        var systemId = options.systemId || 0; //系统识别ID
      ...
      value: function handleError() {
        ...
        window.onerror = function (msg, url, line, col, error) {
          try {
            ...
            _this.errorObj = error; //console.log('url', this.url)
